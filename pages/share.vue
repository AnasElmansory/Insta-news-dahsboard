<template>
  <v-app>
    <div class="page">
      ...
      <v-row no-gutters justify="center" align="center">
        <v-container id="content">
          <v-card elevation="4" rounded="15">
            ...
            <v-card-subtitle>Source Subtitle</v-card-subtitle>
            <v-card-text>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. A
              consectetur reiciendis pariatur distinctio ratione labore
              doloremque modi, tempore ex laudantium odit eius corporis ducimus.
              Veritatis assumenda libero consequatur delectus esse.
            </v-card-text>
          </v-card>
        </v-container>
      </v-row>
      ...
      <v-footer fixed>
        <v-container fluid class="text-center" id="store-button">
          <a href="" target="_blank">
            <img src="../static/google_play.png" alt="google play" />
          </a>
        </v-container>
      </v-footer>
    </div>
